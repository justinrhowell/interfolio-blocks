...
registerBlockType( 'interfolio/block-card', {
	title: __( 'Interfolio Card' ),
	icon: 'layout',
	category: 'common',
	supports: {
		align: true,
	...
	edit: ( { attributes, className, setAttributes } ) => {
		...
		return (
			[
				...
				<div className={ className + ' card-block-container' } style={ containerStyles } key="preview">
					{
						<BlockControls>
							<AlignmentToolbar
								value={ alignment }
					...
					{
						!! image && ! image.sizes[ imageSize ] && (
							<span>Sorry, that we could not find that image in the selected size.</span>
						)
					}
					<PlainText
						value={ headerText }
